...
- 🔍 Search and filter pets based on criteria  
- 📄 View pet details including breed, age, and description  
- ❤️ Match users with suitable pets  
...
- CSS  
- JavaScript  
- (Add frameworks here if used – React / Node.js / Express / MongoDB)
